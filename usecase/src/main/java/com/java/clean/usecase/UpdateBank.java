...
public class UpdateBank {
	private final BankAdapter bankAdapter;
	  ...
	  public UpdateBank(final BankAdapter bankAdapter)
	  {
		this.bankAdapter = bankAdapter;
	  }

	  public Bank updateBank(final Bank bank){
		  
		  var bankToUpdate= Bank.builder()
				  .id(bank.getId())
				  ...
				  .build();
		  return bankAdapter.update(bankToUpdate);
	  }
}
